...
return [
     ...
     */
    'sandbox' => env('SSLC_SANDBOX', filter_var(env('SSLCZ_TESTMODE', true), FILTER_VALIDATE_BOOLEAN)),

    /**
     * The API credentials given from SSLCommerz
     */
    'store' => [
        'id' => env('SSLC_STORE_ID') ?: env('SSLCZ_STORE_ID'),
        'password' => env('SSLC_STORE_PASSWORD') ?: env('SSLCZ_STORE_PASSWORD'),
