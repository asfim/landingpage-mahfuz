...
class ProductLandingPageController extends Controller
{
    ...
    public function store(Request $request, Product $product): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'variant_prices.*.sku' => 'nullable|string|max:100',
            'variant_prices.*.price' => 'nullable|numeric|min:0',
            'variant_prices.*.old_price' => 'nullable|numeric|min:0',
            'variant_prices.*.inside_dhaka_charge' => 'nullable|numeric|min:0',
            'variant_prices.*.outside_dhaka_charge' => 'nullable|numeric|min:0',
